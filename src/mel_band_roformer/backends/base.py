...
decided once in inference.separate_folder_with(). This module and its shape are
ported from bs-roformer-infer's identical seam (this package's fork sibling),
not invented independently -- see that package's brain/architecture.md for the
